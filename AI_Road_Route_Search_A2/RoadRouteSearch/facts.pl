...
distance('Allahabad', 'Allahabad', 0).
...
distance('Coimbatore', 'Coimbatore', 0).
...
distance('Jamshedpur', 'Jamshedpur', 0).
...
distance('Jullundur', 'Jullundur', 0).
...
distance('Trivandrum', 'Trivandrum', 0).
...
distance('Vijayawada', 'Vijayawada', 0).
...
distance('Vishakapatnam', 'Vishakapatnam', 0).
